...
function AddtoHome(time, once) {
    if (once) {
        var AddHomeStatus = localStorage.getItem("MaolanceAddtoHome");
        if (AddHomeStatus === "1" || AddHomeStatus === 1) {
            // already showed up
        }
        else {
            localStorage.setItem("MaolanceAddtoHome", 1)
...
function testMode() {
    ...
    console.clear();
    console.log("%cMaolance", "font-size: 1.3em; font-weight: bold; color: #FFF; background-color: #6236FF; padding: 10px 120px; margin-bottom: 16px;")
    ...
    testModeMsg(Maolance.PWA.enable, "PWA")
    testModeMsg(Maolance.Dark_Mode.default, "Set dark mode as default theme")
    testModeMsg(Maolance.Dark_Mode.local_mode.enable, "Local dark mode (between " + Maolance.Dark_Mode.local_mode.start_time + ":00 and " + Maolance.Dark_Mode.local_mode.end_time + ":00)")
    testModeMsg(Maolance.Dark_Mode.auto_detect.enable, "Auto detect dark mode")
    testModeMsg(Maolance.RTL.enable, "RTL")
    testModeMsg(Maolance.Test.enable, "Test mode")
    testModeMsg(Maolance.Test.alert, "Test mode alert")
    ...
    testModeMsg(Maolance.Animation.goBack, "Go Back")
}
function themeTesting() {
    var word = Maolance.Test.word;
    var value = "";
